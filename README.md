...
### Essa atividade visa criar uma aplicação que simula operações financeiras de saque, depósito e apresentação de extrato, e deve conte validação de CPF para evitar a duplicidade do cadastro de clientes. Dado isso, a aplicação consiste em apresentação de menu ao usuário para que escolha de qual opção utilizará no sistema, o qual promoverá um redirecionando para o menu inicial sempre que finalizar uma tarefa.
...
### 1 - Clone o repositório com o comando : git clone https://github.com/lucianonevesln/python-django-konv.git;

### 2 - Se estiver usando o VSCode, execute o arquivo Python com o botão verde de 'run'. Se preferir, aplique o passo a seguir ou vá direto para o passo 5;

### 3 - Execute o comando 'python' em console;

### 4 - Agora, aplique o comando 'from main import *';

### 5 - Escolha um número conforme indicado em menu;

### 6 - Ao finalizar a utilização do sistema, escolha a opção 6 do menu;
